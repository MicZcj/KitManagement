...
<body>
	...
	<div class="container">
		<div class="row">
			<div align="center">
			<form action="Admin_Usernew.do" method="post" >
				<h1>新增管理员</h1>
				<br>
				<table border="0" height="200px">
					...
					<tr>
						...
						<td><input name="adminNickname" class="form-control" type="text"
							placeholder="请输入旧密码" id="adminNickname"></td>
					</tr>
					<tr>
						<td>姓名</td>
						<td><input name="adminName" class="form-control" type="text"
							placeholder="请输入旧密码"id="adminname"></td>
					</tr>
					<tr>
						<td>密码</td>
						<td><input name="adminPassword" class="form-control" type="text"
							placeholder="请输入旧密码"id="adminPassword"></td>
					</tr>
					<tr>
						<td>权限类别&nbsp;&nbsp;&nbsp;</td>
