...
<body>
	...
	<!-- Home -->
	<section class="header" id="header"> <jsp:include
		page="header.jsp">
	...
	<div class="container">
		<div class="header-table">
			<div class="header-wrapper">
				...
				<p class="header-subtitle">软件工程 2017</p>
			</div>
			<!-- /.header-wrapper -->
		</div>
	</div>
	...
	<div class="container section-wrapper">
		<h2 class="section-title black">工具管理系统</h2>
		<!-- /.section-title -->
		...
		<div class="row">
			<div class="col-sm-3 col-xs-6">
				<div class="fun-box">
					...
					<div class="number-title">工具数</div>
				</div>
				<!-- /.fun-box -->
			</div>
			<!-- /.col-md-3 -->
