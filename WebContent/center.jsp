					...
					<div class="portfolio-item">
						<div class="portfolio-img">
							...
							<div class="portfolio-img-hover">
								<a href="center_info.jsp"><img src="assets/images/plus.png" alt="plus" class="plus"></a>
							</div> <!-- /.portfolio-img-hover -->
						</div> <!-- /.portfolio-img -->
						<div class="portfolio-item-details">
							<div class="portfolio-item-name">
								个人信息<br><small>Personal information</small>
				...
				<div class="col-sm-4 col-xs-6">
					<div class="portfolio-item">
						<div class="portfolio-img">
							...
							<div class="portfolio-img-hover">
								<a href="center_password.jsp"><img src="assets/images/plus.png" alt="plus" class="plus"></a>
							</div> <!-- /.portfolio-img-hover -->
						</div> <!-- /.portfolio-img -->
						<div class="portfolio-item-details">
							<div class="portfolio-item-name">
								修改密码<br><small>Password Change</small>
							</div> <!-- /.portfolio-item-name -->
				...
				<div class="col-sm-4 col-xs-6">
					<div class="portfolio-item">
						<div class="portfolio-img">
							...
							<div class="portfolio-img-hover">
								<a href="center_message.jsp"><img src="assets/images/plus.png" alt="plus" class="plus"></a>
							</div> <!-- /.portfolio-img-hover -->
						</div> <!-- /.portfolio-img -->
						<div class="portfolio-item-details">
							<div class="portfolio-item-name">
								站内通知<br><small>Website Message</small>
							</div> <!-- /.portfolio-item-name -->
